...
public class SignUp extends Endpoint {
    ...
    public void handlePost(HttpExchange r) throws IOException, JSONException {
        ...
        Class[] fieldClasses = new Class[] { String.class, String.class, String.class, String.class, String.class,
        ...
        if (!this.validateFields(body, fields, fieldClasses)) {
            ...
            if (creditcard != null && creditPass != null) {
                rs = this.dao.signupRenter(username, password, name, address, birthday, occupation, SIN, creditcard,
                        creditPass);
